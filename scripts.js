...
function addEventListeners() {
    ...
    document.querySelector('[data-search-form]').addEventListener('submit', (event) => {
        ...
        renderBookList(result.slice(0, BOOKS_PER_PAGE), document.querySelector('[data-list-items]'))
    ...
    document.querySelector('[data-list-button]').addEventListener('click', () => {
        const fragment = document.createDocumentFragment()
        renderBookList(matches.slice(page * BOOKS_PER_PAGE, (page + 1) * BOOKS_PER_PAGE), fragment)
...
function initialize() {
    const starting = document.createDocumentFragment()
    renderBookList(matches.slice(0, BOOKS_PER_PAGE), starting)
